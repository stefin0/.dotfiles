...
dunst fastfetch fd ghostty gimp grim mpv neovim networkmanager \
network-manager-applet noto-fonts noto-fonts-emoji nwg-look pipewire \
pipewire-pulse qt5-wayland qt6-wayland slurp stow tree-sitter-cli ttf-noto-nerd \
